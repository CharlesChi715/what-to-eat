...
Status: early MVP — photo upload, structured GPT-5.6 Sol food recognition, client-rendered item markers, user confirmation, and focused follow-up photos are wired end to end.
